    ...
    <div className="w-full">
      <main className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8 print-container">
        ...
        <div className="flex justify-center mb-8 no-print">
          <Tabs value={appMode} onValueChange={(v) => setAppMode(v as "analyze" | "compare")} className="w-full max-w-md">
                  ...
                  <Tabs value={inputMode} onValueChange={(v) => setInputMode(v as "text" | "file")} className="flex flex-col">
                    ...
                    <TabsContent value="text" className="mt-0">
                      <Textarea 
                        ...
                        className="w-full min-h-[300px] lg:min-h-[450px] max-h-[50vh] overflow-y-auto resize-y p-4 text-base font-mono bg-white border-neutral-200 focus-visible:ring-blue-500 shadow-sm"
                        value={contractText}
                ...
                <div className="flex flex-col gap-4">
                  <div>
                    ...
                    <Textarea 
                      ...
                      className="w-full min-h-[150px] lg:min-h-[200px] max-h-[35vh] overflow-y-auto resize-y p-4 text-sm font-mono bg-white border-neutral-200 focus-visible:ring-blue-500 shadow-sm"
